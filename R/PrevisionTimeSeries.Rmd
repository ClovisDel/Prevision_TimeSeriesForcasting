...
Le résultat obtenu est correct. La corrélation avec un décalage de 12
est donc très forte.
...
```{r}
library(prophet)
names(data_train)[1] <- "ds"
data_train$ds <- strptime(as.character(data_train$ds), "%Y-%m-%d ")
names(data_train)[2] <- "y"
