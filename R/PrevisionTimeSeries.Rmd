...
-\> on distingue des saisonnalités =\> faire régression ca n'a pas de
sens =\> modèle de Buys Ballot
...
MAPE = (1/n) \* Σ(\|actual -- forecast\| / \|actual\|) \* 100 "a MAPE
value of 6% means that the average difference between the forecasted
