...
En supprimant la tendance on observe la saisonnalité.
...
On distingue des saisonnalités =\> faire une régression simple n'a pas de sens, nous utiliserons le modèle de Buys Ballot.

On remarque une bonne répartition du bruit avec quelques outliers
